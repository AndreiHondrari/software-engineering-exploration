"""
Extract variable number of bits from a bitfield (with limits) - from LSB
"""
...
def extract_bits_from_lsb(
    ...
    for i in range(stop-start+1):
        nth_bitfield = value & (0b1 << (i + start))
...
if __name__ == '__main__':
    ...
    res2: int = extract_bits_from_lsb(a, 0, 2)
    res3: int = extract_bits_from_lsb(a, 0, 7)
    res4: int = extract_bits_from_lsb(a, 4, 6)
