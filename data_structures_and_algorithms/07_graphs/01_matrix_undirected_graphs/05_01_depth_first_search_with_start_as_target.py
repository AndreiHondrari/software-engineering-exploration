...
from graph import add_edge, depth_first_search
...
def main() -> None:
    ...
    print(f"Perform depth first search for {TARGET} from {TARGET}")
    target_found, result_edges = depth_first_search(V, E, TARGET, TARGET)
